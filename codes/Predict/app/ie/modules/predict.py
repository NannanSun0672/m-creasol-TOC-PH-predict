...
class Predict_result(object):
    def __init__(self):
        ...
        self.TOC_pred = joblib.load(os.path.join(os.path.dirname(os.path.abspath(__file__)),"A_model/TOC_Pred.pkl"))
        self.IP_pred = joblib.load(os.path.join(os.path.dirname(os.path.abspath(__file__)),"A_model/IP_Pred.pkl"))
    def predict_result(self,input_data):
        ...
        Res = {"TOC去除率":TOC_pred[0],"间甲酚转化率":IP_pred[0]}
